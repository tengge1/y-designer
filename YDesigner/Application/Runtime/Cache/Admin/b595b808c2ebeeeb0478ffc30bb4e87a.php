                    ...
                    <div class="accordionContent">
                        <ul class="tree treeFolder expand">
                            <li>
                                ...
                                <ul>
                                    <?php if($user_type == '01'): ?><li><a href="<?php echo U('User/index');?>" target="navTab" rel="yd_user">用户管理</a></li><?php endif; ?>
                                    <li><a href="<?php echo U('App/index');?>" target="navTab" rel="yd_app">应用管理</a></li>
                                    <?php if($user_type == '01'): ?><li><a href="<?php echo U('Article/index');?>" target="navTab" rel="yd_article">使用帮助</a></li><?php endif; ?>
                                </ul>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="navTab-panel tabsPageContent layoutBox">
                    <div class="page unitBox">
                        <div class="accountInfo">
                            ...
                            <p>
                                通知总数：<?php echo ($article_count); ?> &nbsp;&nbsp;&nbsp;&nbsp;
                                用户总数：<?php echo ($user_count); ?> &nbsp;&nbsp;&nbsp;&nbsp;
                                应用总数：<?php echo ($app_count); ?> &nbsp;&nbsp;&nbsp;&nbsp;
                            </p>
                        </div>
